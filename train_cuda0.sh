...
# YOLOv4
cd /home/ayina/MscThesis/DCW/YOLOv4;  /home/ayina/anaconda3/envs/cottonweeddetection/bin/python   train.py --device 1 --batch-size 16 --img 640 640 --epochs 300 --data cottonweedsdetection_seed0.yaml --cfg cfg/yolov4.cfg --weights 'yolov4.pt' --name yolov4
