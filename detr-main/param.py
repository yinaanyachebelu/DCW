...
def get_args_parser():
    ...
    # dataset parameters
    parser.add_argument('--dataset_file', default='weed')
    parser.add_argument(
        '--data_path', default='/home/ayina/MscThesis/DCW/datasets/Dataset_final/DATA_0_COCO_format/', type=str)
    ...
    parser.add_argument('--resume', default='weights/detr-r50-e632da11.pth', help='resume from checkpoint')
